...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Samuel Chavez" => "samchavez61@gmail.com" }
  # Or just: spec.author    = "Samuel Chavez"
  # spec.authors            = { "Samuel Chavez" => "schavez@ids.com.mx" }
  # spec.social_media_url   = "https://twitter.com/Samuel Chavez"
  ...
  #
  spec.source       = { :git => 'https://github.com/zamuset/KnobControl.git', :tag => "1.0.0" }
